      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 py-8 sm:py-16">
        ...
        <div className="hidden lg:flex items-center gap-12">
          ...
          <div className="flex-shrink-0">
            <div className="relative w-[700px] h-[175px] overflow-hidden rounded-xl shadow-lg">
              <Image
                src="/banner.webp"
                alt="Zenith Education"
                fill
          ...
          <div className="flex-1 text-white space-y-6">
            <div className="space-y-4">
              <h1 className="text-2xl xl:text-2xl font-bold leading-tight">
                2025 Weekly Class Schedule
              </h1>
              <p className="text-sm xl:text-sm text-blue-100 font-medium">
                Flexible scheduling • Expert tutors • Proven results
              </p>
            </div>
